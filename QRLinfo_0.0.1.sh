...
#          GetCPUInfo
#           echo -e "CPU Info"
#           echo -e "{\"hostname\":\""$hostname"\", \"user\":\""$user"\", \"distro\":\""$distro"\", \"uptime\":\""$uptime"\"}\n"
#        ;;
#        --LSCPU|-lc)
#           echo -e "lscpu"
#           echo -e "$cpuInfo"
...
#          Dep_Check
#          QRL_CHECK
#           #echo -e "QRL NODE INFO"
#           #echo -e "{\"Version\":\""$qrlVersion"\", \"Running"\":\""$qrlRuns"\", \"QRL_Process"\":\""$qrlProcess"\"}\n"
#           #echo -e "$blockheight"
#           #echo -e "\n"
#        ;;
#        -h|--help)
#        echo -e "+--------------------------------------+"
#        echo -e "\t REQUIRED INFO NEEDED! \n "
#        echo -e "Please enter a valid query \n "
#        echo -e "\t .$workingDIR/$scriptName --CPU | -c"
#        echo -e "\t .$workingDIR/$scriptName --QRL | -q"
#        echo -e "\t .$workingDIR/$scriptName --LSCPU | -lc"
#        ;;
#esac
